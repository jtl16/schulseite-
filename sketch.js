...
function setup() {
 ...
 termine.position(10+200, 10+100);
 rect(5, 8, 390, 22);
 klasse = createDiv('Klasse');
 klasse.position(10+200, 35+100);
 rect(5, 30, 60, 22);
 std = createDiv('Std.');
 std.position(70+200, 35+100);
 rect(65, 30, 50, 22);
 lehrera = createDiv('Lehrer/in');
 lehrera.position(120+200, 35+100);
 rect(115, 30, 130, 22);
 facha = createDiv('Fach');
 facha.position(250+200, 35+100);
 rect(245, 30, 50, 22);
 rauma = createDiv('Raum');
 rauma.position(300+200, 35+100);
 rect(295, 30, 100, 22);
 fill(255, 250, 205);
 anderungen = createDiv('Vertretungen und Änderungen');
 anderungen.position(400+200, 10+100);
 rect(395, 8, 386, 22);
 lehrern = createDiv('Lehrer/in');
 lehrern.position(400+200, 35+100);
 rect(395, 30, 80, 22);
 fachn = createDiv('Fach');
 fachn.position(480+200, 35+100);
 rect(475, 30, 40, 22);
 raumn = createDiv('Raum');
 raumn.position(520+200, 35+100);
 rect(515, 30, 60, 22);
 bemerkung = createDiv('Informationen/Bemerkungen');
 bemerkung.position(580+200, 35+100);
 rect(575, 30, 206, 22);
 fill(0, 190, 250);
 rect(5, 52, 776, 20);
 if (a == 0) {
